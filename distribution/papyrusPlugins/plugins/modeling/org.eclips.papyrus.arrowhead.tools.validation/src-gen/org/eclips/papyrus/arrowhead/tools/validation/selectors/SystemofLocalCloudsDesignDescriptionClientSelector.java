 ...
 * @generated
 */
public class SystemofLocalCloudsDesignDescriptionClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "SystemofLocalCloudsDesignDescription"); //$NON-NLS-1$
	}
}
