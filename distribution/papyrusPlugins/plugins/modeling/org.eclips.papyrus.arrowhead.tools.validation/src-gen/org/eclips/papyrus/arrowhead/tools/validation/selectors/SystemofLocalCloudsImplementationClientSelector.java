 ...
 * @generated
 */
public class SystemofLocalCloudsImplementationClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "SystemofLocalCloudsImplementation"); //$NON-NLS-1$
	}
}
