 ...
 * @generated
 */
public class ProcurementAndEngineeringClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "ProcurementAndEngineering"); //$NON-NLS-1$
	}
}
