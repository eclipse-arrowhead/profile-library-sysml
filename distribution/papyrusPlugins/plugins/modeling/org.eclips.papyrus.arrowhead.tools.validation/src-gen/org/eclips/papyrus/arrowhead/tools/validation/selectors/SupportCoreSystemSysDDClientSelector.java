 ...
 * @generated
 */
public class SupportCoreSystemSysDDClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "SupportCoreSystemSysDD"); //$NON-NLS-1$
	}
}
