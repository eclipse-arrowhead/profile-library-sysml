 ...
 * @generated
 */
public class SystemofLocalCloudsEvolutionClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "SystemofLocalCloudsEvolution"); //$NON-NLS-1$
	}
}
