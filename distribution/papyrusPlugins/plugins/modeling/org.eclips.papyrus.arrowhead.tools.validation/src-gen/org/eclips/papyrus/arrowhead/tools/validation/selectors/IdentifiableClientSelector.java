 ...
 * @generated
 */
public class IdentifiableClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "Identifiable"); //$NON-NLS-1$
	}
}
