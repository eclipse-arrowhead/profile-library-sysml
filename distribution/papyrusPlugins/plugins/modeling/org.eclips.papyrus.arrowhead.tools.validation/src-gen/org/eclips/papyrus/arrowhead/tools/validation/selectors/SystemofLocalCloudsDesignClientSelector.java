 ...
 * @generated
 */
public class SystemofLocalCloudsDesignClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "SystemofLocalCloudsDesign"); //$NON-NLS-1$
	}
}
