 ...
 * @generated
 */
public class DeployedDeviceClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "DeployedDevice"); //$NON-NLS-1$
	}
}
