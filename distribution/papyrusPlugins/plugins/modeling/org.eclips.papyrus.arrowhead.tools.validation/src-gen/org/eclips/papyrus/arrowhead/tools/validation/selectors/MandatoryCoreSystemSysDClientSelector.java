 ...
 * @generated
 */
public class MandatoryCoreSystemSysDClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "MandatoryCoreSystemSysD"); //$NON-NLS-1$
	}
}
