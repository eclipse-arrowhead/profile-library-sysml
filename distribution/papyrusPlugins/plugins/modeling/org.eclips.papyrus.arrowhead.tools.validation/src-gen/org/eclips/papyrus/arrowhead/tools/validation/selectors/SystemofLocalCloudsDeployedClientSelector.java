 ...
 * @generated
 */
public class SystemofLocalCloudsDeployedClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "SystemofLocalCloudsDeployed"); //$NON-NLS-1$
	}
}
