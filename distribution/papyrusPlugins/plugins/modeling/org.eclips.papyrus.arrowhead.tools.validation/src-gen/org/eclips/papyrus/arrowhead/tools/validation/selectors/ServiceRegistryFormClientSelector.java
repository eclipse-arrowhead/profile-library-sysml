 ...
 * @generated
 */
public class ServiceRegistryFormClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "ServiceRegistryForm"); //$NON-NLS-1$
	}
}
