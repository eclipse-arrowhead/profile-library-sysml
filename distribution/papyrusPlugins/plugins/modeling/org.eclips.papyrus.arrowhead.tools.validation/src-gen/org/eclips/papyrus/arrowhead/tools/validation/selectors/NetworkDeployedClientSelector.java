 ...
 * @generated
 */
public class NetworkDeployedClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "NetworkDeployed"); //$NON-NLS-1$
	}
}
