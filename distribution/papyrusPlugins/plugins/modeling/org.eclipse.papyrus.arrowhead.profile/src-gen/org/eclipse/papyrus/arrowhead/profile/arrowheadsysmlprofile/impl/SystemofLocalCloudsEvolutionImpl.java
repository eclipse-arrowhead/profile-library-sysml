...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Systemof Local Clouds Evolution</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.arrowhead.profile.arrowheadsysmlprofile.impl.SystemofLocalCloudsEvolutionImpl#getBase_Class <em>Base Class</em>}</li>
 *   <li>{@link org.eclipse.papyrus.arrowhead.profile.arrowheadsysmlprofile.impl.SystemofLocalCloudsEvolutionImpl#getSystemoflocalcloudsdeployed <em>Systemoflocalcloudsdeployed</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemofLocalCloudsEvolutionImpl extends MinimalEObjectImpl.Container implements SystemofLocalCloudsEvolution {
	/**
	 ...
	 * @generated
	 */
	protected SystemofLocalCloudsEvolutionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ArrowheadSysMLProfilePackage.Literals.SYSTEMOF_LOCAL_CLOUDS_EVOLUTION;
	}
		...
		if (base_Class != null && base_Class.eIsProxy()) {
			...
			if (base_Class != oldBase_Class) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ArrowheadSysMLProfilePackage.SYSTEMOF_LOCAL_CLOUDS_EVOLUTION__BASE_CLASS, oldBase_Class, base_Class));
			}
		}
		return base_Class;
	}
	...
	public void setBase_Class(org.eclipse.uml2.uml.Class newBase_Class) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArrowheadSysMLProfilePackage.SYSTEMOF_LOCAL_CLOUDS_EVOLUTION__BASE_CLASS, oldBase_Class, base_Class));
	}
	...
	public SystemofLocalCloudsDeployed getSystemoflocalcloudsdeployed() {
		if (systemoflocalcloudsdeployed != null && systemoflocalcloudsdeployed.eIsProxy()) {
			...
			if (systemoflocalcloudsdeployed != oldSystemoflocalcloudsdeployed) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ArrowheadSysMLProfilePackage.SYSTEMOF_LOCAL_CLOUDS_EVOLUTION__SYSTEMOFLOCALCLOUDSDEPLOYED, oldSystemoflocalcloudsdeployed, systemoflocalcloudsdeployed));
			}
		}
	...
	public void setSystemoflocalcloudsdeployed(SystemofLocalCloudsDeployed newSystemoflocalcloudsdeployed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArrowheadSysMLProfilePackage.SYSTEMOF_LOCAL_CLOUDS_EVOLUTION__SYSTEMOFLOCALCLOUDSDEPLOYED, oldSystemoflocalcloudsdeployed, systemoflocalcloudsdeployed));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArrowheadSysMLProfilePackage.SYSTEMOF_LOCAL_CLOUDS_EVOLUTION__BASE_CLASS:
				if (resolve) return getBase_Class();
				return basicGetBase_Class();
			case ArrowheadSysMLProfilePackage.SYSTEMOF_LOCAL_CLOUDS_EVOLUTION__SYSTEMOFLOCALCLOUDSDEPLOYED:
...
} //SystemofLocalCloudsEvolutionImpl
