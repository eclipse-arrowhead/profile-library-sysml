...
public class YAMLTester extends PropertyTester {
	
	//The property to check
	public static final String IS_YAML = "isYAML";
	...
	public boolean test(Object receiver, String property, Object[] args, Object expectedValue) {
		...
		if (IS_YAML.equals(property) && receiver instanceof IStructuredSelection){
			Object object = null;
